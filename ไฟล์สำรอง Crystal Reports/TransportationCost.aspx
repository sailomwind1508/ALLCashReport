...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="header">
        <asp:Label ID="lblPageName" runat="server" Text="Transportation Cost"></asp:Label>
    </div>
    ...
    <div class="line4_footer">
        <div style="width: 100%;">
            ...
            <div id="tabs" style="width: 120%; height: 100%; font-size: 14px;">
                <ul>
                    <li><a href="#tabs-1">รายงาน</a></li>
                    <li><a href="#tabs-2">รายละเอียดการขนส่ง</a></li>
                    <li><a href="#tabs-3">เพิ่ม/แก้ไขรายละเอียดการขนส่ง</a></li>
                    <li><a href="#tabs-4">อัตราค่าขนส่ง-นำเข้า Excel</a></li>
                </ul>
                            ...
                            <tr>
                                ...
                                <div style="width: 100%; font-size: 14px;">
                                        ...
                                        <asp:GridView ID="grdTransReport1" runat="server" AutoGenerateColumns="false" CssClass="mydatagrid" PagerStyle-CssClass="pager"
                                            ...
                                            CellPadding="4" DataKeyNames="ROW_NO" EmptyDataText="No records Found" Width="100%" ShowHeaderWhenEmpty="true" AllowSorting="true" OnSorting="grdTransReport1_Sorting" OnPageIndexChanging="grdTransReport1_PageIndexChanging">
                                             <Columns>
                                                <asp:BoundField DataField="ROW_NO" HeaderText="ลำดับ" SortExpression="ROW_NO" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                <asp:BoundField DataField="Month" HeaderText="เดือน/ปี" SortExpression="Month" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                                                <asp:BoundField DataField="SalesAreaCode" HeaderText="รหัสสาขา" SortExpression="SalesAreaCode" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                                                <asp:BoundField DataField="SalesArea" HeaderText="สาขา" SortExpression="SalesArea" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                ...
                                                <asp:BoundField DataField="CarType" HeaderText="ประเภทรถ" SortExpression="CarType" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                                                <asp:BoundField DataField="ShippingCost" HeaderText="อัตราค่าขนส่ง" SortExpression="ShippingCost" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                <asp:BoundField DataField="Quantity" HeaderText="จำนวนหีบทั้งหมด" SortExpression="Quantity" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                <asp:BoundField DataField="Average_Cost_Per_Carton" HeaderText="ค่าขนส่งต่อหีบ" SortExpression="Average_Cost_Per_Carton" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N4}" />
                                            </Columns>
                        ...
                        <table style="width: 100%;">
                            <tr style="white-space: nowrap;">
                                <td style="text-align: right">
                                    <asp:Label ID="Label13" runat="server" Text="สาขา : "></asp:Label>&nbsp;</td>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTranDateDT" runat="server" Width="150px" ViewStateMode="Enabled" EnableViewState="true" AutoPostBack="true" OnTextChanged="txtTranDateDT_TextChanged"></asp:TextBox>

                                </td>
                                <td style="text-align: right">
                                    <asp:Label ID="Label9" runat="server" Text="ทะเบียนรถ : "></asp:Label>&nbsp;</td>
                                <td>
                            ...
                            <tr style="white-space: nowrap;">
                                <td style="text-align: right">
                                    <asp:Label ID="Label10" runat="server" Text="เลขที่เอกสาร : "></asp:Label>&nbsp;</td>
                                ...
                                <td style="text-align: right">
                                    <asp:Label ID="Label12" runat="server" Text="ประเภทรถ : "></asp:Label>&nbsp;</td>
                                <td>
