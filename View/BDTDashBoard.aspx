<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BDTDashBoard.aspx.cs" Inherits="View_BDTDashBoard" %>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <h6 class="m-0 font-weight-bold" style="color: black;">
                    <asp:Literal ID="lblTitleBDT" runat="server"></asp:Literal></h6>
                <div class="table-responsive">
                    <asp:GridView ID="grdDash1" runat="server" AutoGenerateColumns="true" class="" Width="1810px" CellSpacing="0"
                        ...
                        <HeaderStyle BackColor="#F8CBAD" Font-Bold="True" ForeColor="Black" CssClass="header-center" />
                ...
                <h6 class="m-0 font-weight-bold" style="color: black;">
                    <asp:Literal ID="lblTitleEX1" runat="server"></asp:Literal></h6>
                <div class="table-responsive">
                    <asp:GridView ID="grdDash3" runat="server" AutoGenerateColumns="true" class="" Width="1810px" CellSpacing="0"
                        BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
                        EmptyDataText="No records Found" ShowHeaderWhenEmpty="true" OnRowDataBound="grdDash3_RowDataBound">
                        <Columns>
                        </Columns>
                        <PagerStyle CssClass="pagination-ys" />
                        <FooterStyle BackColor="#99CCCC" ForeColor="#1F438F" />
                        <HeaderStyle BackColor="#66FFFF" Font-Bold="True" ForeColor="Black" CssClass="header-center"  />
                        <PagerStyle BackColor="#99CCCC" ForeColor="#1F438F" HorizontalAlign="Left" />
                        <RowStyle BackColor="White" ForeColor="Black" CssClass="rowStyle" />
                        <SelectedRowStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
                        <SortedAscendingCellStyle BackColor="#EDF6F6" />
                ...
                <h6 class="m-0 font-weight-bold" style="color: black;">
                    <asp:Literal ID="lblTitleEX2" runat="server"></asp:Literal></h6>
                <div class="table-responsive">
                    <asp:GridView ID="grdDash4" runat="server" AutoGenerateColumns="true" class="" Width="1810px" CellSpacing="0"
                        BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
                        EmptyDataText="No records Found" ShowHeaderWhenEmpty="true" OnRowDataBound="grdDash4_RowDataBound">
                        <Columns>
                        </Columns>
                        <PagerStyle CssClass="pagination-ys" />
                        <FooterStyle BackColor="#99CCCC" ForeColor="#1F438F" />
                ...
                <h6 class="m-0 font-weight-bold" style="color: black;">
                    <asp:Literal ID="lblTitleMT" runat="server"></asp:Literal></h6>
                <div class="table-responsive">
                    <asp:GridView ID="grdDash2" runat="server" AutoGenerateColumns="true" class="" Width="1810px" CellSpacing="0"
                        BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
                        EmptyDataText="No records Found" ShowHeaderWhenEmpty="true" OnRowDataBound="grdDash2_RowDataBound">
                        <Columns>
                        </Columns>
                        <PagerStyle CssClass="pagination-ys" />
                        <FooterStyle BackColor="#99CCCC" ForeColor="#1F438F" />
