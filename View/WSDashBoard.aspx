<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WSDashBoard.aspx.cs" Inherits="View_WSDashBoard" %>

<%@ Register Src="~/WebUserControl_DashBoard.ascx" TagPrefix="uc1" TagName="WebUserControl_DashBoard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <asp:GridView ID="grdData2" runat="server" AutoGenerateColumns="true" class="" Width="1810px" CellSpacing="0"
                    BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
            ...
            <div class="table-responsive">
                <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="true" class="" Width="1810px" CellSpacing="0"
                    BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
