    ...
    <div class="">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdDash3" runat="server" AutoGenerateColumns="true" class="" Width="100%" CellSpacing="0"
                        BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdDash4" runat="server" AutoGenerateColumns="true" class="" Width="100%" CellSpacing="0"
                        BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdDash2" runat="server" AutoGenerateColumns="true" class="" Width="100%" CellSpacing="0"
                        BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
