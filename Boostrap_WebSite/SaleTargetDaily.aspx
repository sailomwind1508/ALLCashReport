...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card">
        <div class="card-header header bg-gradient-primary">
            <asp:Image ID="Image5" runat="server" ImageUrl="~/img/target.png" Width="50px" />
            <asp:Label ID="Label8" runat="server" Text="รายงานเป้าหมายของแผนก WS" CssClass="text-white"></asp:Label>
        </div>
    ...
    <div class="line4_footer">
        <div style="width: 100%;">
            ...
            <div id="tabs" style="width: 100%; font-family: Verdana,Arial,sans-serif; font-size: 14px;">
                <ul>
                    <li><a href="#tabs-1">
                        <asp:Image ID="Image18" runat="server" ImageUrl="~/img/report.png" Width="23px" Height="25px" />&nbsp;รายงานเป้าหมายเทียบยอดจดของแผนก WS</a></li>
                </ul>
                <div id="tabs-1">
                    <div style="width: 100%;">
                                ...
                                <td style="white-space: nowrap; text-align: left">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:LinkButton ID="btnReport" runat="server" OnClick="btnReport_Click" Style="width: 120px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;" class="btn btn-primary btn-user btn-block" ValidationGroup="Report">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="ddlEmployee" runat="server" Height="25px" Width="280px" class="dropdown-divider" ViewStateMode="Enabled" EnableViewState="true"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="btnReport2" runat="server" OnClick="btnReport2_Click" Style="width: 120px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;" class="btn btn-primary btn-user btn-block" ValidationGroup="Report2">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="ddlEmployee2" runat="server" Height="25px" Width="280px" class="dropdown-divider" ViewStateMode="Enabled" EnableViewState="true"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="btnReport3" runat="server" OnClick="btnReport3_Click" Style="width: 120px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;" class="btn btn-primary btn-user btn-block" ValidationGroup="Report3">
