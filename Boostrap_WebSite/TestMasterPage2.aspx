<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="TestMasterPage2.aspx.cs" Inherits="TestMasterPage2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        $(function () {
            $('[id*=grdAccMng]').prepend($("<thead></thead>").append($('[id*=grdAccMng]').find("tr:first"))).DataTable();

            $('[id*=grdUser]').prepend($("<thead></thead>").append($('[id*=grdUser]').find("tr:first"))).DataTable();

            //$('#ContentPlaceHolder1_grdUser').prepend($("<thead></thead>").append($('#ContentPlaceHolder1_grdUser').find("tr:first"))).DataTable();
            ...
            <div style="width: 100%; font-size: 14px; color: black;">
                ...
                <div id="tabs" style="width: 100%; height: 100%">
                    ...
                    <div id="tabs-1">
                        ...
                        <br />
                        <br />
                        <asp:GridView ID="grdAccMng" runat="server" AutoGenerateColumns="false" class="table"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PageDesc" HeaderText="Page Description" />
                        ...
                        <table style="width: 100%; height: 150px">
                            ...
                            <tr>
                                <td colspan="2">
                                    <br />
                                    <br />
                                    <asp:GridView ID="grdUser" runat="server" AutoGenerateColumns="false" class="table"
