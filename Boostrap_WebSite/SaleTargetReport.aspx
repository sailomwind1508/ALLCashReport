...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card">
        <div class="header bg-gradient-primary">
            <asp:Image ID="Image8" runat="server" ImageUrl="~/img/target.png" Width="50px" />
            <asp:Label ID="Label14" runat="server" Text="Sales Target Management" CssClass="text-white"></asp:Label>
        </div>
    </div>
    ...
    <div class="line_footer">
        <div style="width: 100%; position: absolute;">
            ...
            <div id="tabs" style="width: 120%; height: 100%; font-size: 14px;">
                <ul>
                    <li><a href="#tabs-1">
                        <asp:Image ID="Image18" runat="server" ImageUrl="~/img/excel_img.png" Width="23px" Height="25px" />&nbsp;Report</a></li>
                    <li><a href="#tabs-2">
                        <asp:Image ID="Image7" runat="server" ImageUrl="~/img/document.png" Width="23px" Height="25px" />&nbsp;Update Target</a></li>
                </ul>
                <div id="tabs-1">
                    <div style="width: 100%;">
                        <div>
                        ...
                        <div style="width: 100%">
                            <table style="width: 100%">
                                <tr style="white-space: nowrap;">
                                    <td style="text-align: left; vertical-align: bottom; width: 55%;">
                                        ...
                                        <asp:DropDownList ID="ddlED_Month" runat="server" Height="25px" Width="80px" class="dropdown-divider" ViewStateMode="Enabled" EnableViewState="true"></asp:DropDownList>

                                        &nbsp;&nbsp;
                                        <asp:Label ID="Label10" runat="server" Text="ปี : "></asp:Label>&nbsp;
                                        <asp:DropDownList ID="ddlED_Year" runat="server" Height="25px" Width="80px" class="dropdown-divider" ViewStateMode="Enabled" EnableViewState="true"></asp:DropDownList>
                                    ...
                                    <td style="text-align: left; width: 45%;">&nbsp;&nbsp;
                                        <asp:LinkButton ID="btnED_Search" runat="server" OnClick="btnED_Search_Click" Style="width: 100px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;" class="btn btn-primary btn-user btn-block" ValidationGroup="Report">
                            ...
                            <table>
                                <tr style="white-space: nowrap;">
                                    <td>
                                        ...
                                        <asp:LinkButton ID="lnkExportEditTarget" runat="server" Visible="false" OnClick="lnkExportEditTarget_Click" OnClientClick="return closeDialog();" Style="width: 120px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;" class="btn btn-primary btn-user btn-block" ValidationGroup="Report">
                                    ...
                                    <td>
                                        <a id="btnSaveTG" runat="server" href="#" title="" visible="false" style="width: 120px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;"
