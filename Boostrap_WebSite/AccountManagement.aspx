...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card">
        <div class="card-header header bg-gradient-primary">
            <asp:Image ID="Image6" runat="server" ImageUrl="~/img/setting.png" Width="50px" />
            <asp:Label ID="lblAccMngHeader" runat="server" Text="Account Management" CssClass="text-white"></asp:Label>
        </div>
        <div class="card-body">
            <div style="width: 100%; font-size: 14px; color: black;">
                ...
                <div id="tabs" style="width: 100%; height: 100%">
                    ...
                    <div id="tabs-1" style="overflow-x: scroll;">
                        <div style="position: absolute; left: 35%; width: 400px; color: white;">
                            <asp:LinkButton ID="linkAddUser" runat="server" OnClick="linkAddUser_Click" Style="width: 120px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;"
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div style="position: absolute; left: 35%; width: 400px; color: white;">
                                        ...
                                        <a id="btnSave_User" runat="server" href="#" title="" style="width: 120px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;"
                                            class="btn btn-primary" onclick="return SaveUser();">
                                            <asp:Image ID="Image3" runat="server" ImageUrl="~/img/floppy-disk.png" Width="23px" />Save
                                        </a>

                                        <%--<asp:Button ID="btnSave_User" runat="server"  class="btn btn-primary" Text="Save" Width="150px" ValidationGroup="AddAcc" />--%>
                                    </div>

                                    <div style="position: absolute; left: 47%; width: 155px;">

                                        <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" class="btn btn-primary" Text="Cancel" Width="120px" />
                                    </div>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div style="position: absolute; left: 25%; width: 155px;">
                                        <a id="btnSave_Per" runat="server" href="#" title="" style="width: 120px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;"
                                            class="btn btn-primary" onclick="return SavePer();">
                                            <asp:Image ID="Image4" runat="server" ImageUrl="~/img/floppy-disk.png" Width="23px" />Save
                                        </a>
                                        <%-- <asp:Button ID="btnSave_Per" runat="server"  class="btn btn-primary" Text="Save" Width="150px" ValidationGroup="AddPermis" />--%>
                                    </div>
                                    <div style="position: absolute; left: 37%; width: 155px;">
                                        <asp:Button ID="btnCancel_Per" runat="server" OnClick="btnCancel_Per_Click" class="btn btn-primary" Text="Cancel" Width="120px" />
