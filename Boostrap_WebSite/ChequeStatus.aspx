...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card" style="overflow-x: scroll; position: absolute;width:100%;">

        <div class="card-header header bg-gradient-primary">
            <asp:Image ID="Image5" runat="server" ImageUrl="~/img/cheque.png" Width="50px" />
            <asp:Label ID="Label2" runat="server" Text="Cheque Status Report" CssClass="text-white"></asp:Label>
        </div>
        ...
        <div class="card-body">
            ...
            <button type="button" class="collapsible"><asp:Image ID="Image4" runat="server" ImageUrl="~/img/search.png" Width="23px" Height="25px" />&nbsp;ค้นหาเพิ่มเติม</button>
