<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TransferStockByVAN.aspx.cs" Inherits="TransferStockByVAN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card">
        <div class="card-header header bg-gradient-primary">
            ...
            <asp:Label ID="Label4" runat="server" Text="Transfer Stock Daily By VAN Report" CssClass="text-white"></asp:Label>
        </div>
        ...
        <div class="card-body">
            <div style="width: 100%;">
                ...
                <div id="tabs" style="width: 100%; font-family: Verdana,Arial,sans-serif; font-size: 14px;">
                    <ul>
                        <li><a href="#tabs-1">
                            <asp:Image ID="Image2" runat="server" ImageUrl="~/img/report.png" Width="23px" Height="25px" />&nbsp;Transfer Stock Daily By VAN</a></li>
                    </ul>
                    <div id="tabs-1" style="width: 100%;">
                        <table style="width: 100%;">
                            ...
                            <asp:DropDownList ID="ddlBranch" runat="server" Height="25px" Width="221px" class="dropdown-divider"></asp:DropDownList>
                                    &nbsp;&nbsp;
