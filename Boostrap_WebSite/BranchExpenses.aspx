<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BranchExpenses.aspx.cs" Inherits="BranchExpenses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card">
        <div class="card-header header bg-gradient-primary">
            <asp:Image ID="Image11" runat="server" ImageUrl="~/img/fuel-station.png" Width="50px" />
            <asp:Label ID="Label14" runat="server" Text="รายงานค่าน้ำมัน" CssClass="text-white"></asp:Label>
        </div>
    </div>
    ...
    <div style="width: 80%; position: absolute;">
        ...
        <div id="tabs" style="width: 100%; font-family: Verdana,Arial,sans-serif; font-size: 14px;">
            <ul>
                ...
                <li><a href="#tabs-3">
                    <asp:Image ID="Image6" runat="server" ImageUrl="~/img/document.png" Width="23px" Height="25px" />&nbsp;ข้อมูลค่าน้ำมัน</a></li>
                <li><a href="#tabs-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/excel_img.png" Width="23px" Height="25px" /><label>เลือกไฟล์ Excel ค่าน้ำมัน</label>
                                            ...
                                            <tr style="white-space: nowrap;">
                                                <td style="text-align: left">
                                                    <asp:Label ID="Label10" runat="server" Text="สถานะการส่ง : " />&nbsp;
                                                        ...
                                                        <asp:DropDownList ID="ddlDocStatus" runat="server" Height="25px" Width="150px" class="dropdown-divider" ViewStateMode="Enabled" EnableViewState="true"></asp:DropDownList>
                                                    &nbsp;&nbsp;
                                                    ...
                                                    &nbsp;&nbsp;
                                                        ...
                                                        <asp:DropDownList ID="ddlVanID_R" runat="server" Height="25px" Width="120px" class="dropdown-divider" ViewStateMode="Enabled" EnableViewState="true"></asp:DropDownList>
                                                        &nbsp;&nbsp;--%>
                                                    <asp:Label ID="Label6" runat="server" Text="วันที่ส่ง : "></asp:Label>&nbsp;
                                                    
                                                        <asp:TextBox ID="txtTransferDate_R" runat="server" Width="120px" ViewStateMode="Enabled" EnableViewState="true" MaxLength="30"></asp:TextBox>
                            ...
                            <tr>
                                <td colspan="5" style="width: 100%">
                                    <div class="modal-body" style="width: 100%; font-size: 14px;">
                                        ...
                                        <asp:GridView ID="grdBExns" runat="server" AutoGenerateColumns="false" CssClass="mydatagrid" PagerStyle-CssClass="pager"
                                            HeaderStyle-CssClass="header_grid" RowStyle-CssClass="rows" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" PageSize="50" AllowPaging="true" OnRowCommand="grdBExns_RowCommand"
                                            CellPadding="4" DataKeyNames="PK" EmptyDataText="No records Found" Width="100%" ShowHeaderWhenEmpty="true" AllowSorting="true" OnSorting="grdBExns_Sorting" OnPageIndexChanging="grdBExns_PageIndexChanging" OnRowDataBound="grdBExns_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="รหัสสาขา" HeaderText="รหัสสาขา" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                                                ...
                                                <%--<asp:BoundField DataField="VanID" HeaderText="แวน" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />--%>
                                                <asp:BoundField DataField="วันที่ส่งเอกสาร" HeaderText="วันที่ส่งเอกสาร" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" DataFormatString="{0:dd/MM/yyyy}" />
                                                <asp:BoundField DataField="สถานะการส่งข้อมูล" HeaderText="สถานะการส่งข้อมูล" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                                                <asp:BoundField DataField="สถานะเอกสาร" HeaderText="สถานะเอกสาร" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                            ...
                            <tr>
                                <td colspan="6" style="width: 100%">
                                    <div class="modal-body" style="width: 100%; font-size: 14px;">
                                        ...
                                        <asp:GridView ID="grdBEDT" runat="server" AutoGenerateColumns="false" CssClass="" PagerStyle-CssClass="pager"
                                            HeaderStyle-CssClass="header_grid" RowStyle-CssClass="rows" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" PageSize="200" AllowPaging="true" OnRowCommand="grdBEDT_RowCommand"
                                            CellPadding="4" DataKeyNames="PK" EmptyDataText="No records Found" Width="100%" ShowHeaderWhenEmpty="true" AllowSorting="true" OnSorting="grdBEDT_Sorting" OnRowDataBound="grdBEDT_RowDataBound" OnPageIndexChanging="grdBEDT_PageIndexChanging">
                                            <Columns>
                                                <asp:BoundField DataField="ลำดับ" HeaderText="ลำดับ" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                                                ...
                                                <asp:BoundField DataField="วันที่เติมน้ำมัน" HeaderText="วันที่เติมน้ำมัน" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" DataFormatString="{0:dd/MM/yyyy}" />
                                                ...
                                                <asp:BoundField DataField="FLEET CARD NO." HeaderText="FLEET CARD NO." ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                <asp:BoundField DataField="เล่มที่/เลขที่" HeaderText="เล่มที่/เลขที่" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                <asp:BoundField DataField="เลขประจำตัวผู้เสียภาษี" HeaderText="เลขประจำตัวผู้เสียภาษี" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                <asp:BoundField DataField="ชื่อผู้ให้บริการ" HeaderText="ชื่อผู้ให้บริการ" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                <asp:BoundField DataField="สถานประกอบการ" HeaderText="สถานประกอบการ" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                ...
                                                <asp:BoundField DataField="ราคา/ลิตร" HeaderText="ราคา/ลิตร" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                <asp:BoundField DataField="จำนวนลิตร" HeaderText="จำนวนลิตร" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                <asp:BoundField DataField="ไมล์ เริ่มต้น" HeaderText="ไมล์ เริ่มต้น" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N0}" />
                                                <asp:BoundField DataField="ไมล์ สิ้นสุด" HeaderText="ไมล์ สิ้นสุด" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N0}" />
                                                ...
                                                <asp:BoundField DataField="เลขไมล์เติมน้ำมัน" HeaderText="เลขไมล์เติมน้ำมัน" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N0}" />
                                                <asp:BoundField DataField="หมายเหตุ" HeaderText="หมายเหตุ" ItemStyle-Wrap="true" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                <asp:BoundField DataField="แก้ไขโดย" HeaderText="แก้ไขโดย" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                <asp:BoundField DataField="วันที่แก้ไขล่าสุด" HeaderText="วันที่แก้ไขล่าสุด" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
                                            </Columns>
                                            <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="White" CssClass="header-center" />
                                ...
                                <td style="width: 250px; text-align: left">
                                    <div class="modal-header">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label11" runat="server" Text="วันที่เติมน้ำมัน(จาก) : "></asp:Label>&nbsp;
                                                    
                                                        <asp:TextBox ID="txtDateFrom" runat="server" Width="120px" ViewStateMode="Enabled" EnableViewState="true" MaxLength="30"></asp:TextBox>
                                                    &nbsp;&nbsp;
                                                        <asp:Label ID="Label12" runat="server" Text="วันที่เติมน้ำมัน(ถึง) : "></asp:Label>&nbsp;
                            ...
                            <tr>
                                <td colspan="5" style="width: 100%">
                                    <div class="modal-body" style="width: 100%; font-size: 14px;">
                                        ...
                                        <asp:GridView ID="grdRanking" runat="server" AutoGenerateColumns="true" CssClass="mydatagrid" PagerStyle-CssClass="pager"
                                            ...
                                            <Columns>
                                                ...
                                                <%--<asp:BoundField DataField="No" HeaderText="ลำดับ" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                                                    <asp:BoundField DataField="TransferDate" HeaderText="วันที่ส่ง" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" DataFormatString="{0:dd/MM/yyyy}" />
                                                    <asp:BoundField DataField="DocDate" HeaderText="วันที่" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" DataFormatString="{0:dd/MM/yyyy}" />
                                                    <asp:BoundField DataField="BranchID" HeaderText="รหัสศูนย์" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="centerRow" />
                                                    <asp:BoundField DataField="BranchName" HeaderText="ชื่อศูนย์" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                    <asp:BoundField DataField="VanID" HeaderText="แวน" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                    <asp:BoundField DataField="Licences" HeaderText="ทะเบียนรถ" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                    <asp:BoundField DataField="FleetGardNo" HeaderText="FLEET GARD NO." ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                    <asp:BoundField DataField="TopTotal" HeaderText="ค่าน้ำมันต่อวัน" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    <asp:BoundField DataField="DocNo" HeaderText="เล่มที่/เลขที่" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-CssClass="leftRow" />
                                                    <asp:BoundField DataField="VATNumber" HeaderText="เลขประจำตัวผู้เสียภาษี" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    <asp:BoundField DataField="CarrierName" HeaderText="ชื่อผู้ให้บริการ" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    <asp:BoundField DataField="Establishment" HeaderText="สถานประกอบการ" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    <asp:BoundField DataField="ExcVat" HeaderText="มูลค่าสินค้าหรือบริการ" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    <asp:BoundField DataField="VatAmt" HeaderText="จำนวนเงินภาษีมูลค่าเพิ่ม" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    <asp:BoundField DataField="TotalDue" HeaderText="จำนวนเงินรวม" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    
                                                    <asp:BoundField DataField="PricePerLiter" HeaderText="ราคา/ลิตร" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    <asp:BoundField DataField="LiterAmt" HeaderText="จำนวนลิตร" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N2}" />
                                                    <asp:BoundField DataField="StartMile" HeaderText="ไมล์ เริ่มต้น" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N0}" />
                                                    <asp:BoundField DataField="EndMile" HeaderText="ไมล์ สิ้นสุด" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N0}" />
                                                    <asp:BoundField DataField="MileUsed" HeaderText="จำนวนไมล์ใช้งาน" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N0}" />
                                                    <asp:BoundField DataField="AddFuelMileNo" HeaderText="เลขไมล์เติมน้ำมัน" ItemStyle-Wrap="false" HeaderStyle-CssClass="header-center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N0}" />
                                        ...
                                        <asp:GridView ID="grdRankM" runat="server" Visible="false" AutoGenerateColumns="false" CssClass="mydatagrid" PagerStyle-CssClass="pager"
                                            HeaderStyle-CssClass="header_grid" RowStyle-CssClass="rows" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" PageSize="50" AllowPaging="true" OnRowCommand="grdRanking_RowCommand"
                                            CellPadding="4" DataKeyNames="PK" EmptyDataText="No records Found" Width="100%" ShowHeaderWhenEmpty="true" AllowSorting="true" OnSorting="grdRanking_Sorting" OnPageIndexChanging="grdRanking_PageIndexChanging" OnRowDataBound="grdRanking_RowDataBound">
                                            <Columns>
                                            </Columns>
                                            <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="White" CssClass="header-center" />
    ...
    <div id="dialog-oil-dt" title="รายละเอียด" style="display: none; font-size: 14px;" class="save-dialog-message">
        <table style="width: 100%;">
            <tr>
                <td style="text-align: right;">
                    <asp:LinkButton ID="btnExportOilDT" runat="server" Visible="false" OnClick="btnExportOilDT_Click" OnClientClick="return closeDialog();" Style="width: 100px; font-family: Verdana,Arial,sans-serif; font-size: 1em; color: white;" class="btn btn-primary" ValidationGroup="SearchDT">
