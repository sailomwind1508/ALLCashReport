...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card">
        <div class="card-header header bg-gradient-primary">
            ...
            <asp:Label ID="Label4" runat="server" Text="Xena & SAP Comparison Report" CssClass="text-white"></asp:Label>
        </div>
        ...
        <div class="card-body">
            <div style="width: 100%;">
                ...
                <div id="tabs" style="width: 100%; font-family: Verdana,Arial,sans-serif; font-size: 14px;">
                    <ul>
                        <li><a href="#tabs-1">
                            <asp:Image ID="Image2" runat="server" ImageUrl="~/img/report.png" Width="23px" Height="25px" />&nbsp;Xena & SAP Comparison</a>
